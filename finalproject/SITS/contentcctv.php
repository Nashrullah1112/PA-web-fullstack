...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="../news/berita.php">Berita</a>
        ...
        <li class="nav-item">
          <a class="nav-link" href="../khalayak umum/tampilan.php">Jalan-jalan</a>
        <li class="nav-item">
      ...
      <!-- Close Navbar -->
      <!--link google-->
      <iframe src="http://jasamargalive.com/webjm3/mjm/index.php?r=site/getarea&a=25&b=963"
        width="1000" height="1000" style="border:0;"></iframe>
